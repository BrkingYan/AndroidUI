...
public class SharedPreferencesUtil {
    ...
    public static Object getData(String key, Object defaultValue) {
        ...
        try {
            switch (type) {
                case "Boolean":
                    result = sPreferences.getBoolean(key, (Boolean) defaultValue);
                    break;
                case "Long":
                    result = sPreferences.getLong(key, (Long) defaultValue);
                    break;
                case "Float":
                    result = sPreferences.getFloat(key, (Float) defaultValue);
                    break;
                case "String":
                    result = sPreferences.getString(key, (String) defaultValue);
                    break;
                case "Integer":
                    result = sPreferences.getInt(key, (Integer) defaultValue);
                    break;
                default:
                    Gson gson = new Gson();
